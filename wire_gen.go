...
func InitializeApp() (*App, error) {
	...
	blobConfig, err := util.NewBlobConfig(sugaredLogger)
	if err != nil {
		return nil, err
	}
	releaseNoteServiceImpl, err := pkg.NewReleaseNoteServiceImpl(sugaredLogger, gitHubClient, moduleConfig, releaseNoteRepositoryImpl, blobConfig)
	if err != nil {
		return nil, err
	}
